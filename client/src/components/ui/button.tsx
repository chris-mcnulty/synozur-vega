...
const buttonVariants = cva(
  ...
  " hover-elevate active-elevate-2",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground border border-primary-border [box-shadow:oklab(0.618048_0.128263_-0.207656_/_0.25)_0px_20px_25px_-5px]",
        destructive:
        ...
        secondary: "border bg-secondary text-secondary-foreground border border-secondary-border [box-shadow:rgba(0,0,0,0.05)_0px_1px_2px_0px]",
